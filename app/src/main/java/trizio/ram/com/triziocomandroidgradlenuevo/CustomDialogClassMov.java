 ...
 */
public class CustomDialogClassMov
        extends Dialog
    ...
    public CustomDialogClassMov(Activity a, String grupo, String proceso, String tamano, String ip, String empresa
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_dialog_mov);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_yes:
                ...
                Intent intent = new Intent(getContext(),Recepcion.class);
            ...
            case R.id.btnVer:
                ...
                intent = new Intent(getContext(), (Class) Guardar.class);
