...
public class BodegaTerminar extends Activity {
String conexion = "";
    String user = "";
    String pass = "";
    String ip = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url1 = "http://" + ip + "/procesoSiguienteHydro.php";
        ...
        try {
            ...
            System.out.println("PROCESO SIGUIENTE " +array1.get(0));
        }catch (JSONException e ){
            e.printStackTrace();
        }

        if (tipo.equals("mercar")){
            System.out.println("procesoooooooooooooooooooooooo anterior" + procesoAnterior);
            proceso = procesoAnterior;
        }else {
            //proceso = array2.get(0);
        }

        //String url = "http://" + ip + "/consultarSucursalHydro.php";
        ...
        try {
            ...
            if ((sucursal.length>0)) {
                ...
                Toast.makeText(getApplicationContext(),"no hay autos para entregar!", Toast.LENGTH_LONG).show();
            }
                ...
                public void onItemClick(AdapterView<?> parent, View v,
                    ...
                    if (position%2==0){
                        if (sucursal[position].equals("TOTAL")){
                            ...
                            Intent intent = new Intent((Context) BodegaTerminar.this, (Class) BodegaRomboTerminar.class);
