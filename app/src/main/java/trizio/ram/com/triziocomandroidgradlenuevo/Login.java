...
public class Login
    ...
    class ActualizarFechas extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            for (int i = 0;i<ids.size()-1;i++){
                String url2 = "http://" + Ip + "/guardarPruebaHydro.php";
    ...
    public void matriz(View v){
        String url = "http://10.0.10.194:8090/Matrix32x32Hydro.php";
        ...
        String url1 = "http://10.0.10.194:8090/puertoSerieHydro.php";
    ...
    public void procedimiento(View v){
        String url = "http://" + Ip + "/procedimientoHydro.php";
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    nomProcesos.add(json.getString("nom_proceso").trim());
                    ...
                    System.out.println("ESTOS SON LOS PROCESOS ->" + procesos.get(i) + " - " + nomProcesos.get(i));
                }
            } catch (JSONException e) {
                red = false;
                e.printStackTrace();
