                ...
                public void onClick(View arg0) {
                    ...
                    lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> pariente, View view, int posicion, long id) {
                            ...
                            if (elegido.get_textoEncima().trim().equals("REQUERIMIENTO")) {
                                Intent intent = new Intent((Context) Procesos.this, (Class) Recepcion.class);
                                Bundle bundle2 = new Bundle();
                                bundle2.putString("user", user);
                                bundle2.putString("pass", pass);
                            ...
                            if (elegido.get_textoEncima().trim().equals("REVISION")) {
                                Intent intent = new Intent((Context) Procesos.this, (Class) PanelLateral.class);
                                Bundle bundle2 = new Bundle();
                                ...
                                bundle2.putStringArrayList("autoNextProcesos", autoNextProcesos);
                                bundle2.putString("ipconsulta","");
                                bundle2.putString("ip", ip);
                            ...
                            if (elegido.get_textoEncima().trim().equals("MOVIMIENTOS")) {
                                ...
                                bundle.putStringArrayList("autoNextProcesos",new ArrayList<String>());
