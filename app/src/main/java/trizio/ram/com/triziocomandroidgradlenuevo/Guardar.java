...
public class Guardar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // guardar.setVisibility(View.INVISIBLE);
        ...
        tipreq = bundle.getString("tipreq");
        ...
        if (descripcionModelo.trim().equals("")) {
            ...
            String url4 = "http://" + ip + "/consultarGeneral2Hydro.php";
            ...
            String url = "http://" + ip + "/consultarGeneral2Hydro.php";
        ...
        /*String url = "http://" + ip + "/atributosHydro.php";
        ...
        for (int i = 0;i<columnas.size();i++){
            if (columnas.get(i).trim().equals("SERIE")){
                cod_placa = datos.get(i).trim();
            }
        }
    ...
    class GuardarMovimiento extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            String url2 = "http://" + ip + "/guardarMovimientoHydro.php";
            ...
            String url1 = "http://" + ip + "/actualizarCitaHydro.php";
            ...
            params.add(new BasicNameValuePair("sDescModelo", tipreq));
            ...
            try {
                ...
                guardarMovimiento();
            /*String url2 = "http://" + ip + "/aumentarConsecutivoHydro.php";
            List<NameValuePair> params2 = new ArrayList<NameValuePair>();
            String resultServer2 = getHttpPost(url2, params2);
            System.out.println(resultServer2);
            try {
    ...
    class GuardarEncabezado extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            for (int i = 0;i<columnas.size()-1;i++){
                if (columnas.get(i).equals("REQUERIMIENTO")){
                    sql += "ROMBO" + ",";
                }else{
                    sql += columnas.get(i) + ",";
                }
            ...
            if (consecutivo) {
                ...
                try {
                    ...
                    url3 = "http://" + ip + "/guardarMovimientoHydro.php";
                    ...
                    url6 = "http://" + ip + "/consultarGeneralHydro.php";
                    ...
                    try {
                        ...
                        String url5 = "http://" + ip + "/guardarMovimientoHydro.php";
    ...
    public void guardar (View v) {
        ...
        /*String url4 = "http://" + ip + "/consultarPlacaHydro.php";
...
*/
        ...
        /*for (int i = 0;i<rutas.size();i++) {
            ...
            String url3 = "http://" + ip + "/desactivarRomUbicHydro.php";
       ...
       /* String url3 = "http://" + ip + "/consultarGeneralHydro.php";
        ...
        /*String url2 = "http://192.168.1.190:8080/guardarPruebaHydro.php";
